...
func viewRun(opts *ViewOptions) error {
	project, err := selectors.ResolveProject(opts.Client, opts.Ask, opts.PromptEnabled,
		"Select the project containing the channel you wish to view", opts.flags.Project.Value)
	if err != nil {
		return err
	}
